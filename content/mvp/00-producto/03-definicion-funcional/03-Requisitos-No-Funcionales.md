...
| NFR-005 | `Aislamiento por organizacion y perfil de acceso` | quien puede ver y operar informacion dentro del sistema | actores del sistema, supuestos base, objetivos del sistema | operacion por organizacion, acceso por rol, seguimiento por cuenta |
...
| NFR-011 | `Localizacion operativa y cumplimiento configurable por pais` | el comportamiento del sistema por pais o region | contexto operativo / crecimiento esperado, objetivos del sistema | `Operacion preparada para crecimiento regional`; operacion regional, reportes, retencion, reglas por pais |
...
| Actores del sistema | aporta necesidades de visibilidad, seguridad, trazabilidad y confiabilidad |
...
| Contexto operativo / crecimiento esperado | define presiones de escala, disponibilidad, regionalizacion y evolucion controlada |
